defmodule DemoLiveview.TimelineTest do
  use DemoLiveview.DataCase

  alias DemoLiveview.Timeline

  describe "posts" do
    alias DemoLiveview.Timeline.Post

    @valid_attrs %{body: "some body", likes: 42, reposts_count: 42, username: "some username"}
    @update_attrs %{body: "some updated body", likes: 43, reposts_count: 43, username: "some updated username"}
    @invalid_attrs %{body: nil, likes: nil, reposts_count: nil, username: nil}
